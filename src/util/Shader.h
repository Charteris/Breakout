...
class Shader {
 ...
 public:
   ...
   */
  inline void setFloat(const char* varName, float value);
   ...
   */
  inline void setVector2f(const char* varName, const glm::vec2& value);
   ...
   */
  inline void setVector3f(const char* varName, const glm::vec3& value);
   ...
   */
  inline void setVector4f(const char* varName, const glm::vec4& value);
   ...
   */
  inline void setMatrix4(const char* varName, const glm::mat4& value);
